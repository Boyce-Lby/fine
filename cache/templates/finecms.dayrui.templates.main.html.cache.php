...
<div class="row" style="margin-bottom: 20px">
    <div class="col-md-12">
        <div class="admin-usermenu">
            ...
            <a class="btn <?php if ($t['color'] && $t['color']!='default') {  echo $t['color'];  } else { ?>btn-default<?php } ?>" href="<?php echo $t['url']; ?>"> <?php echo $t['name']; ?> </a> <?php } } ?>
        </div>
    </div>
</div>
<?php } ?>
                ...
                <div>
                    <table class="table table-light mtable">
                        <tr>
                            ...
                            <td>&nbsp;<a href="<?php echo dr_url('upgrade/index'); ?>"> v<?php echo DR_VERSION; ?>&nbsp; <b style="color:red" id="finecms_version"></b> </a></td>
                        </tr>
                        <tr>
